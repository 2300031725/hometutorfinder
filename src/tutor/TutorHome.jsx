      ...
      <div className="features-section">
        ...
        <div className="features-cards">
          <div className="feature-card">
            <img src="https://source.unsplash.com/300x200/?writing,application" alt="Apply as a Tutor" className="feature-image" />
            <h4>Apply as a Tutor</h4>
            <p>Create an account and submit your qualifications for review.</p>
          </div>
          <div className="feature-card">
            <img src="https://source.unsplash.com/300x200/?profile,form" alt="Complete Your Profile" className="feature-image" />
            <h4>Complete Your Profile</h4>
            <p>Add your subjects, experience, availability, and set your hourly rate.</p>
          </div>
          <div className="feature-card">
            <img src="https://source.unsplash.com/300x200/?teaching,classroom" alt="Get Matched with Students" className="feature-image" />
            <h4>Get Matched with Students</h4>
            <p>Once approved, students can find you and request tutoring sessions.</p>
          </div>
          <div className="feature-card">
            <img src="https://source.unsplash.com/300x200/?teaching,success" alt="Teach and Earn" className="feature-image" />
